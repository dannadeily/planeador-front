...
const ModificarMateria = () => {
  ...
  useEffect(() => {
    const getMateria = async () => {
      try {
        ...
        const competenciasSeleccionadas = materiaData.Competencias.map((c) => c.Materias_competencias.competencia_id);
  ...
  const handleCompetenciasChange = (e) => {
    ...
    if (materia.competencias.includes(checkboxValue)) {
      ...
      updatedCompetencias = materia.competencias.filter(comp => comp !== checkboxValue);
    } else {
